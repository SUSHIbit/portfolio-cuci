        ...
        <div class="admin-card rounded-lg p-8 mb-6">
            ...
            <div class="mb-6">
                ...
                <textarea id="excerpt" name="excerpt" rows="3" required
                          class="w-full px-4 py-2 rounded-lg border transition-colors duration-300 focus:outline-none focus:ring-2"
                          style="background-color: var(--admin-bg-secondary); border-color: var(--admin-border-primary); color: var(--admin-text-primary);">{{ old('excerpt') }}</textarea>
                @error('excerpt')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="date" id="published_date" name="published_date" value="{{ old('published_date', date('Y-m-d')) }}" required
                           class="w-full px-4 py-2 rounded-lg border transition-colors duration-300 focus:outline-none focus:ring-2"
                           style="background-color: var(--admin-bg-secondary); border-color: var(--admin-border-primary); color: var(--admin-text-primary);">
...
function addImageBlock() {
    ...
    blockDiv.innerHTML = `
        ...
        <input type="file" name="content_blocks[${blockIndex}][content]" accept="image/*" required
               class="w-full px-4 py-2 rounded-lg border transition-colors duration-300 focus:outline-none focus:ring-2"
               style="background-color: var(--admin-bg-secondary); border-color: var(--admin-border-primary); color: var(--admin-text-primary);">
    `;
...
// Add at least one paragraph block on page load
