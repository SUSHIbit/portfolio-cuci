...
@section('content')
<div class="max-w-2xl">
    <form action="{{ route('admin.social-links.store') }}" method="POST" id="social-link-form">
        @csrf

        <div class="bg-white rounded-lg shadow mb-6">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-800">Social Link Details</h2>
                <p class="text-sm text-gray-600">Add a new social media link to your portfolio</p>
            </div>
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div id="icon-preview" class="w-10 h-10 bg-gray-100 rounded flex items-center justify-center">
                            <i id="preview-icon" class="text-gray-400 text-xl"></i>
                        </div>
                    </div>
        ...
        <div class="flex items-center justify-between">
            ...
            <button type="submit" class="px-6 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                <i class="fas fa-save mr-2"></i>Create Social Link
            </button>
        </div>
    </form>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    updateIconPreview(iconClassInput.value);
});
